...
internal class StatRepository : MsSqlFluentRepository<Stat>
{
...
[FluentTable("stat")]
internal class Stat : IFluentModel
{
    [FluentField("student_count")]
    public int Count { get; set; }
}

internal class ReadAllTester
{
    internal static void TV2(SqlConnection connector)
    {
