...
{
    public class SQLiteIsBetweenCondition<T, TProperty> : SQLiteValuesCondition<T, TProperty>
    {
        ...
        public override SQLiteParameter[]? GetSqlParameters() => new SQLiteParameter[] { new($"{ParameterName}_1", Value), new($"{ParameterName}_2", Value2) };
